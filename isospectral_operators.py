...
def l_q_lazutkin(domain, q, function):
    ...
    ## Lazutkin_weight should be computed at the parameter
    ## corresponding to Lazutkin parameter x; there should be a
    ## conversion invoked somewhere
